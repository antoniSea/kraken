...
<template>
    ...
    <div class="w-full flex flex-col items-center justify-center min-h-[70vh]">
      <AuthenticationCard>
        ...
        <form @submit.prevent="submit" :class="['register-form  bg-opacity-80 p-8 rounded-lg shadow-lg max-w-2xl mx-auto', form.processing ? 'opacity-60 pointer-events-none' : '']">
