    ...
    >
        <div class=" px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
            <div class="sm:flex sm:items-center justify-center">
                <div class="hidden mx-auto shrink-0 flex items-center justify-center size-12 rounded-full bg-red-100 sm:mx-0 sm:size-10">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ms-4 sm:text-center">
