...
<template>
    <div>
        ...
        <AgeGate :show="showAgeGate" @accept="handleAcceptAge" @decline="handleDeclineAge" />
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <div class="ms-3 relative">
                                <!-- Teams Dropdown -->
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.auth.user && $page.props.auth.user.current_team" align="right" width="60">
                                    <template #trigger>
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Switcher -->
                                            <template v-if="$page.props.auth.user && $page.props.auth.user.all_teams && $page.props.auth.user.all_teams.length > 1">
